...
@connect((store) => {        
    return {                       
        dialogValidationUF: store.commonDialogs.validationUF,                                    
...
class DndProfiles extends Component {
    ...
    handleClose = () => {
        this.props.dispatch(DialogsActions.resetValidationOpenUF()); 
        this.props.dispatch(DialogsActions.updateValidationOpenUF(false));        
    };
    _handleOnpushDND(obj) {                        
        ...
        this.props.dispatch(ActionsSearchUsers.updateUserFacultiesDND(this.props.userFacultiesDND,obj.listDND2));        
    };
    ...
    render() { 
        ...
        return ( 
            ...
            <Dialog     
                ...
                modal={true}
                open={this.props.dialogValidationUF}
                contentStyle={{
                    width: '95%',                    
                    maxWidth: 'none',
            ...
            > 
                ...
                <div className="row"> 
                    <div className="col s12" >
                    <DragDrop 
                        facultiesList = {this.props.userFacultiesDND[0]}                        
                        facultiesListAssigned = {this.props.userFacultiesDND[1]}
